...
import {
  fetchAdPerfRows, aggregateAccounts, aggregateCampaigns, aggregateAdsets, aggregateAds,
  emptyTotals, addRow, finalizeTotals, previousPeriod, pctChange,
...
export async function GET(request: NextRequest) {
  try {
    ...
    const accountFilter = shop === 'all' ? null : (SHOP_TO_META_ACCOUNT[shop] ?? 'NONE');
