...
// Paginacja przeciw serwerowemu capowi 1000 wierszy PostgREST (jak w marketing/route.ts)
...
// Poprzedni okres o tej samej długości, kończący się dzień przed date_from
